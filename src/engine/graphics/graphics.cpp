...
#include "engine/graphics/cylinder_data.h"
#include "engine/graphics/sphere_data.h"
#include "engine/graphics/cube_data.h"
#include "engine/graphics/VBO_attrib_marker.h"
#include "engine/graphics/shader_attrib_locations.h"
#include "engine/graphics/texture.h"
#include "engine/graphics/texture_2D.h"
...
void Graphics::setWireframe(bool wire) {
    wireframe = wire;
    if(wire) {
...
void Graphics::particleCheck(bool p) {
    if(p) {
        if(wireframe) {
            glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
        }
